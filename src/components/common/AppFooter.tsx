      ...
      <div className="w-full max-w-[1328px] flex flex-col gap-6 p-6 pb-18">
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <div className="flex items-center gap-2">
              <Button variant={"outline"} size={"sm"} className="border-0">
                <img src="/assets/icons/icons-001.png" alt="@SNS" className="w-6 h-6 mt-[2px]" />
              </Button>
              <Button variant={"outline"} size={"sm"} className="border-0">
                <img src="/assets/icons/icons-002.png" alt="@SNS" className="w-[22px] h-[22px]" />
              </Button>
        ...
        <div className="w-full flex items-start justify-between">
          ...
          <div className="flex flex-col mr-[66px]">
            ...
            <div>
              <p>대표이사 : 개발자 박XX</p>
              <p>사업자번호 : 012-34-112312</p>
              <p>통신판매신고번호 : 2025-KOREA</p>
              <p>주소 : 서울특별시 강남구 테헤란로 427 위워크타워 10층</p>
              <p>대표전호 :02-123-1234 </p>
            </div>
          </div>
        </div>
      </div>
