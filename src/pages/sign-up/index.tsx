...
export default function SignUp() {
  ...
  const [marketingAgreed, setMarketingAgreed] = useState<boolean>(false); // 마케팅 및 광고 동의여부
  ...
  return <main className="w-full h-full min-h-[720px] flex items-center justify-center p-6 gap-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="이메일을 입력해세요." {...field} />
                  </FormControl>
