import { ChartNoAxesCombined, CodeXml, Goal, List, Lightbulb, Rocket, DraftingCompass, Footprints } from "lucide-react";

export const CLASS_CATEGORY = [  {    id:1, label: "전체", category: "", icon : <List/>},
  ...
  {    id:7, label: "마케팅", category: "marketing", icon : <ChartNoAxesCombined/>},
  {    id:8, label: "디자인 일러스트", category: "design", icon : <DraftingCompass/>},
  {    id:9, label: "자기계발", category: "self-development", icon : <Footprints/>},
];
